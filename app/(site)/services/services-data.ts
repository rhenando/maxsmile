...
> = {
  ...
  oral_prophylaxis_cleaning: {
    ...
    bullets: ["Minimum price ₱700", "Scaling + polishing", "After-care tips"],
    whatToExpect: [
      "Minimum price: ₱700",
  ...
  tooth_extraction_bunot: {
    ...
    bullets: ["Minimum price ₱700", "Assessment first", "After-care guidance"],
    whatToExpect: [
      "Minimum price: ₱700",
  ...
  veneers: {
    ...
    bullets: [
      ...
      "Indirect: Ceramage ₱8,000 • Emax ₱13,000 • Zirconia ₱15,000",
    ...
    whatToExpect: [
      ...
      "Indirect Veneers (Emax): ₱13,000 per tooth",
      "Indirect Veneers (Zirconia): ₱15,000 per tooth",
      PPE_NOTE,
    ],
