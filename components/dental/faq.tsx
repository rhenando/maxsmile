...
const faqs = [
  ...
  {
    q: "Do you accept HMO?",
    a: "Please confirm with the clinic before your visit so our staff can check current coverage.",
  },
  {
  ...
  return (
    <section id="faq" className="py-10 sm:py-14">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 rounded-2xl border border-black/10 bg-white p-2 shadow-sm sm:p-3 md:p-4">
