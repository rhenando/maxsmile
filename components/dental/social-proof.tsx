    ...
    <section className="border-y border-black/10 bg-white/60 py-10 sm:py-14">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="w-full rounded-xl border border-black/10 bg-white px-4 py-3 text-sm shadow-sm sm:w-auto">
          ...
          >
            <CarouselContent className="-ml-3">
              {testimonialSlides.map((testimonial) => (
                ...
                >
                  <div className="relative aspect-square w-full overflow-hidden rounded-2xl border border-black/10 bg-white shadow-sm">
                    <Image
            ...
            <CarouselPrevious className="-left-4 hidden border-black/10 bg-white/90 hover:bg-white sm:flex" />
            <CarouselNext className="-right-4 hidden border-black/10 bg-white/90 hover:bg-white sm:flex" />
          </Carousel>
        </div>
      </div>
    </section>
